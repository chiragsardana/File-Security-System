...
{	static String depends_encrypt="file\\";
	...
	public static void encryptTextFileInterface()
	{
		...
		String fileName=getFileName(depends_encrypt);
	...
	public static void decryptTextFileInterface()
	{
		...
		System.out.print("\nEnter Text File Name : ");
		String fileName=getFileName(depends_decrypt);
		System.out.print(fileName);
	}
	...
	public static String getFileName(String depends)//for file name and check the name using FileNameValidator...
	{
		input.nextLine();//so that scanner goes to next line...
		String fileName=input.nextLine();
		Boolean NameChecker,ExistChecker;
